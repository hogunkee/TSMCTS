...
OMP_NUM_THREADS=3 CUDA_VISIBLE_DEVICES=${GPU_ID} python mcts.py --iteration-limit 3000 --gui-off --data-dir /disk1/hogun --num-scenes 50 --seed 12345 --logging --rollout-policy nostep --tree-policy random --exploration 0.5 --object-split unseen --num-objects 5 --block-preaction --tag ${TAG}
