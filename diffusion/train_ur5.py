...
class ContextUnet(nn.Module):
    def __init__(self, in_channels, n_feat = 256, n_classes=1):
        ...
        self.contextembed3 = EmbedFC(n_classes, 1*n_feat)

        self.up0 = nn.Sequential(
            nn.ConvTranspose2d(4 * n_feat, 4 * n_feat, 12, 12), # otherwise just have 2*n_feat
